-- MANITO DATABASE RECOVERY - Restore Comprehensive Chilean Market Data
-- This migration restores the complete service categories and project types
-- that were accidentally removed by the table drops in 20250917210000_ensure_search_tables.sql
...
-- ============================================================================
-- SERVICE CATEGORIES (Complete Chilean Market Data - 40 Services)
-- ============================================================================
...
-- ============================================================================
-- PROJECT TYPES (Complete Chilean Market Data - 36 Projects)
-- ============================================================================
...
-- ============================================================================
-- PROJECT-SERVICE RELATIONSHIPS (Complete Mappings)
-- ============================================================================
...
SELECT 'SERVICE CATEGORIES RESTORED' as status, COUNT(*) as count FROM service_categories;
SELECT 'PROJECT TYPES RESTORED' as status, COUNT(*) as count FROM project_types;
SELECT 'PROJECT SERVICES RESTORED' as status, COUNT(*) as count FROM project_services;